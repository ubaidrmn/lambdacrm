...
import type { CreateLeadRequestData, UpdateLeadRequestData } from "../types";
import { CreateLeadSchema } from "../schemas";

function EditLeadSheet(props: { initialData: { title: string; expectedAmount: number; status: LeadStatus; notes: string }}) {
    ...
    return (
        <Sheet>
            ...
            <SheetContent>
                ...
                <SheetDescription>
                    Update the details below to edit this lead.
                </SheetDescription>
                </SheetHeader>
