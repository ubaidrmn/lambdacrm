...
import type { CreateContactRequestData } from "../types";
import { MutateContactSchema } from "../schemas";
import type { Lead } from "@/types/lead.model";

function AddContactSheet(props: { leads: Lead[] }) {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      const data: CreateContactRequestData = {
      ...
      const mutationResponse = await createContactMutation.mutate(data);
      queryClient.invalidateQueries(["get-contacts"] as any);
